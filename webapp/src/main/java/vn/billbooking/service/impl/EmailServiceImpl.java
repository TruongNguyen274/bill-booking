...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public boolean sendEmailForRegister(String type, EmailTemplateDTO emailTemplateDTO) {
        try {
            ...
            switch (type.toUpperCase()) {
                case "USER":
                    html = templateEngine.process("mail/welcome_user.html", context);
                    break;
                case "OWNER":
                    html = templateEngine.process("mail/welcome_owner.html", context);
                    break;
                default:
                    break;
            }
