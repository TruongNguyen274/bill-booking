    ...
    Selectpicker.prototype = {
        constructor: Selectpicker, init: function () {
            ...
            var liHeight = a.offsetHeight, headerHeight = header ? header.offsetHeight : 0,
                ...
                menuStyle = getComputedStyle ? getComputedStyle(menu) : false, $menu = menuStyle ? $(menu) : null,
...
;(function ($) {
    ...
    $.fn.cycle.API = {
        opts: function () {
            ...
            $(opts.slides[opts.currSlide]).css({opacity: 1, display: 'block', visibility: 'visible'});
            ...
            var opts = this.opts(), slideOpts = opts.API.getSlideOpts(),
            ...
            if (startSlideshow) {
                if (!opts._initialized)
                    opts.API.initSlideshow(); else if (opts.timeout) {
...
(function ($) {
    "use strict";
    $.extend($.fn.cycle.defaults, {autoHeight: 0, autoHeightSpeed: 250, autoHeightEasing: null});
...
(function ($) {
    ...
    $(document).on('cycle-bootstrap', function (e, opts) {
        ...
        function add(slides, prepend) {
            var slideArr = [];
            if ($.type(slides) == 'string')
                slides = $.trim(slides); else if ($.type(slides) === 'array') {
...
(function ($) {
    ...
    function Plugin($container, options) {
        ...
        var self = this, $viewport = $container.find(".viewport"), $overview = $container.find(".overview"),
            ...
            $thumb = $scrollbar.find(".thumb"), hasTouchEvents = ("ontouchstart" in document.documentElement),
            wheelEvent = "onwheel" in document.createElement("div") ? "wheel" : document.onmousewheel !== undefined ? "mousewheel" : "DOMMouseScroll",
            isHorizontal = this.options.axis === 'x', sizeLabel = isHorizontal ? "width" : "height",
            posiLabel = isHorizontal ? "left" : "top", mousePosition = 0;
...
(function (h, f) {
    ...
    function f(a) {
        for (var c = a._util, b = 0; b < c.count; b++) {
            var d = c.images[b], g = d.getBoundingClientRect();
    ...
    function t(a, c, b) {
        if (c || 0 < a.offsetWidth && 0 < a.offsetHeight) if (c = a.getAttribute(n) || a.getAttribute(b.src)) {
    ...
    function k(a, c) {
        if (a && c) for (var b = a.length, d = 0; d < b && !1 !== c(a[d], d); d++) ;
    }
...
(function ($) {
    ...
    function init(opts) {
        var $menu = $(this), activeRow = null, mouseLocs = [], lastDelayLoc = null, timeoutId = null,
            menuTimeoutId = null, inMenu = false, options = $.extend({
                rowSelector: "> li",
                submenuSelector: "*",
...
;(function (g, c) {
    ...
    function g(c) {
        ...
        var b = {searchSelector: "*AND", diacriticsMap: {}};
        a.options = {};
    ...
    g.prototype = {
        constructor: g, _processEventListeners: function (c) {
            ...
            for (var b = this, d = b._getContentTags(a ? "" : c), e, h = 0, f; f = d[h]; h++) if (!f.hasAttribute("data-jets") || a) e = this.options.manualContentHandling ? this.options.manualContentHandling(f) : b.options.columns && b.options.columns.length ? b.options.columns.map(function (a) {
            ...
            var a = this.options.diacriticsMap, b;
            for (b in a) if (a.hasOwnProperty(b)) for (var d = 0, e = a[b].length; d < e; d++) c = c.replace(new RegExp(a[b][d], "g"), b);
            return c
        }, update: function (c) {
...
!function (a, b) {
    ...
    function h(a, b, c) {
        var e = (e = a.getDay() - !c.options.sundayBased) < 0 ? 7 + e : e, h = c.options,
            ...
            j = h.template, k = h.renderWeekNo, l = (new Date).toDateString(), m = [], n = [], o = !1, p = !1, q = 0,
            r = a, s = r.getMonth(), t = r.getFullYear(), u = 0, v = 0, w = !1, x = [], y = h.events, z = null, A = [];
        r.setDate(-e);
        for (var B = 0; B < i; B++)
            if (b && b !== B + 1) r.setDate(r.getDate() + 7); else {
                m = [];
    ...
    return j.prototype.addEvent = function (a, b) {
        ...
        var d = new Date((+a), +b - 1, 1), e = a + "-" + b + (c ? "-" + c : ""), f = this.html[e] || h(d, c, this);
        return this.options.useCache && (this.html[e] = f), {html: f, date: e}
    ...
    function e(a, b, d) {
        var e = b.readValue.call(a, d), k = e.split("/"), e = k[2] + '-' + k[1] + '-' + k[0],
            f = r(e || t(new Date, !0)), g = d.getAttribute(b.timeFormatAttribute), h = !1, i = !1;
    ...
    function i(a, b, c) {
        var d = a.options, e = a.calendar, f = a.datePicker, g = {}, p, i;
        ...
        p = $('.selected-day').data('picker');
        var tomorrow = new Date(p);
        for (i = 1; i < numNight; i++) {
            tomorrow.setDate(tomorrow.getDate() + 1);
            var month = '' + (tomorrow.getMonth() + 1), day = '' + tomorrow.getDate(), year = tomorrow.getFullYear();
            p = [year, month, day].join('-');
            $('*[data-picker="' + p + '"]').addClass('selected-day');
        }
    }
    ...
    function k(a, b) {
        for (var c = a.date, d = ["year", "month", "hour", "minute", "second", "AMPM"], e = ""; (e = d.shift()) && !x(b.target, a.options["select" + e.charAt(0).toUpperCase() + e.slice(1) + "Class"]);) ;
    ...
    function m(a, b) {
        var c = b || s(a.date), d = a.options.renderValue.call(a, a.datePicker, a.currentInput, c),
            e = d && 1 === d.nodeType ? d : a.currentInput, k = d.split("/"), f = k[2] + '-' + k[1] + '-' + k[0];
        d && (e.value = d)
    }

    function n(b) {
        var c = b.options.renderCallback.call(b, b.datePicker, b.currentInput, b.toggled),
            d = c && 1 === c.nodeType ? c : b.currentInput, e = {};
    ...
    function v(a, b, c, d, e) {
        v.events = v.events || [], v.events.push({e: a, t: b, f: c, c: d, i: e || this}), a.addEventListener(b, c, d)
    }
